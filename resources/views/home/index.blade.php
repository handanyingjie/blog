...
@section('content')
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <a href="http://www.muzhuangnet.com/show/269.html" target="_blank" title="木庄网络博客源码">
                    <img src="http://www.muzhuangnet.com/upload/201610/18/201610181557196870.jpg" alt="木庄网络博客源码"
                         class="img-responsive"></a>
            </div>
            <div class="item">
                <a href="http://web.muzhuangnet.com/" target="_blank" title="专业网站建设">
                    <img src="http://www.muzhuangnet.com/upload/201610/24/201610241227558789.jpg" alt="专业网站建设"
                         class="img-responsive"></a>
            </div>
        </div>
        <a class="left carousel-control" href="#focusslide" role="button" data-slide="prev" rel="nofollow"> <span
                    class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> <span class="sr-only">上一个</span>
        </a> <a class="right carousel-control" href="#focusslide" role="button" data-slide="next" rel="nofollow"> <span
                    class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span> <span
                    class="sr-only">下一个</span> </a></div>
    <article class="excerpt-minic excerpt-minic-index">
        <h2><span class="red">【推荐】</span><a target="_blank" href="http://www.muzhuangnet.com/show/269.html"
    ...
    <article class="excerpt excerpt-1" style="">
        <a class="focus" href="{{  route('home_detail') }}" title="用DTcms做一个独立博客网站（响应式模板）" target="_blank">
        ...
        <header>
            <a class="cat" href="{{  route('home_detail') }}" title="MZ-NetBlog主题">MZ-NetBlog主题<i></i></a>
    ...
    <aside class="sidebar">
        ...
        <div class="widget widget_sentence">
            <a href="http://web.muzhuangnet.com/" target="_blank" rel="nofollow" title="专业网站建设">
                <img style="width: 100%" src="http://www.muzhuangnet.com/upload/201610/24/201610241224221511.jpg"
                     alt="专业网站建设"></a>
        </div>
        <div class="widget widget_sentence">
