...
@section('content')
    <header class="article-header">
        <h1 class="article-title"><a href="http://www.muzhuangnet.com/show/269.html" title="用DTcms做一个独立博客网站（响应式模板）">用DTcms做一个独立博客网站（响应式模板）</a>
        </h1>
        <div class="article-meta"> <span class="item article-meta-time">
          <time class="time" data-toggle="tooltip" data-placement="bottom" title=""
                data-original-title="发表时间：2016-10-14"><i class="glyphicon glyphicon-time"></i> 2016-10-14</time>
                    ...
                    data-original-title="MZ-NetBlog主题"><i class="glyphicon glyphicon-list"></i> <a
                        href="http://www.muzhuangnet.com/list/mznetblog/" title="MZ-NetBlog主题">MZ-NetBlog主题</a></span>
    ...
    <article class="article-content">
        <p><img data-original="http://www.muzhuangnet.com/upload/201610/18/201610181557196870.jpg"
                src="http://www.muzhuangnet.com/upload/201610/18/201610181557196870.jpg" alt=""/></p>
        <p>
            文章效果示例，文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字。</p>
    ...
    <div class="article-tags">标签：<a href="http://www.muzhuangnet.com/tags/list/2/" rel="tag">DTcms博客</a><a
                href="http://www.muzhuangnet.com/tags/list/3/" rel="tag">木庄网络博客</a><a
                href="http://www.muzhuangnet.com/tags/list/4/" rel="tag">独立博客</a><a
                href="http://www.muzhuangnet.com/tags/list/5/" rel="tag">修复优化</a>
    </div>
    <div class="relates">
        <div class="title">
            <h3>相关推荐</h3>
        ...
        <form id="comment-form" name="comment-form" action="" method="POST">
            <div class="comment">
                ...
                <div class="comment-box">
                    <textarea placeholder="您的评论或留言（必填）" name="comment-textarea" id="comment-textarea" cols="100%"
                    ...
                    <div class="widget widget-tabs">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation"><a href="#contact" aria-controls="contact" role="tab"
                                                       data-toggle="tab" draggable="false">联系站长</a></li>
                        </ul>
                            ...
                            <div role="tabpanel" class="tab-pane contact" id="contact">
                                <h2>QQ:
                                    <a href="http://wpa.qq.com/msgrd?v=3&amp;uin=577211782&amp;site=qq&amp;menu=yes"
                                       target="_blank" rel="nofollow" data-toggle="tooltip" data-placement="bottom"
                                       title="" draggable="false" data-original-title="QQ:577211782">577211782</a>
                                </h2>
                                <h2>Email:
                                    <a href="mailto:577211782@qq.com" target="_blank" data-toggle="tooltip"
                                       rel="nofollow" data-placement="bottom" title="" draggable="false"
